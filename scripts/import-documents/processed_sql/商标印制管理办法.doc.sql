INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_a2c1fe2c5cfb', '商标印制管理办法.doc', 0, '# 标印制管理办法
...
(二) 被许可人印制商标标识的, 应有明确的授权书, 或其所提供的《商标使用许可合同》

含有许可人允许其印制商标标识的内容；

（三）被许可人的商标标识样稿应当标明被许可人的企业名称和地址；其注册标记的使用符合《商标法实施条例》的有关规定。

第六条 委托印制未注册商标的，商标印制委托人提供的商标图样应当符合下列要求：', 770);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_a772b65dedc5', '商标印制管理办法.doc', 1, '容；
...
第十二条 擅自设立商标印刷企业或者擅自从事商标印刷经营活动的，由所在地或者行为地工商行政管理局依照《印刷业管理条例》的有关规定予以处理。', 751);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_effcf3659eff', '商标印制管理办法.doc', 2, '最高不超过三万元，没有违法所得的，可以处以一万元以下的罚款。
...
第十六条 本办法自 2004 年 9 月 1 日起施行。国家工商行政管理局 1996 年 9 月 5 日发布的《商标印制管理办法》同时废止。', 592);