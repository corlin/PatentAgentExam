INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_20a8b1edcbdd', '驰名商标认定和保护规定.doc', 0, '驰名商标认定和保护规定（2014）
...
第六条 当事人在商标不予注册复审案件和请求无效宣告案件中，依照商标法第十三条规定请求驰名商标保护的，可以向商标评审委员会提出驰名商标保护的书面请求并提交其商标构成驰名商标的证据材料。', 705);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_7665aee49e87', '驰名商标认定和保护规定.doc', 1, '标的证据材料。
...
前款所称 “三年”、“五年”，是指被提出异议的商标注册申请日期、被提出无效宣告请求的商标注册申请日期之前的三年、五年，以及在查处商标违法案件中提出驰名商标保护请求日期之前的三年、五年。', 746);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_97a4966cdebd', '驰名商标认定和保护规定.doc', 2, '区域等材料。
...
商标局、商标评审委员会在认定驰名商标时，需要地方工商行政管理部门核实有关情况的，相关地方工商行政管理部门应当予以协助。', 796);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_dc4d4eb685e5', '驰名商标认定和保护规定.doc', 3, '考虑商标法第十四条第一款和本规定第九条所列各项因素，但不以满足全部因素为前提。
...
第十七条 在商标违法案件中，当事人通过弄虚作假或者提供虚假证据材料等不正当手段骗取驰名商标保护的，由商标局撤销对涉案商标已作出的认定，并通知报送驰名商标认定请示的省（自治区、直辖市）工商行政管理部门。', 727);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_c722bc523bb4', '驰名商标认定和保护规定.doc', 4, '第十七条 在商标违法案件中，当事人通过弄虚作假或者提供虚假证据材料等不正当手段骗取驰名商标保护的，由商标局撤销对涉案商标已作出的认定，并通知报送驰名商标认定请示的省（自治区、直辖市）工商行政管理部门。
...
第二十一条 本规定自公布之日起 30 日后施行。2003 年 4 月 17 日国家工商行政管理总局公布的《驰名商标认定和保护规定》同时废止。', 449);