INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_35053bbf9b19', '9-集成电路布图设计保护条例.doc', 1, '# (第300号)
...
二00一年四月二日', 90);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_59b852d65770', '9-集成电路布图设计保护条例.doc', 2, '# 集成电路布图设计保护条例

第一章 总则

第一条 为了保护集成电路布图设计专有权，鼓励集成电路技术的创新，促进科学技术的发展，制定本条例。', 72);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_a11b0721bbdd', '9-集成电路布图设计保护条例.doc', 3, '# 第二条 本条例下列用语的含义：
...
第五条 本条例对布图设计的保护, 不延及思想、处理过程、操作方法或者数学概念等。(相关资料: 部门规章 1 篇 实务指南)

第六条 国务院知识产权行政部门依照本条例的规定，负责布图设计专有权的有关管理工作。', 736);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_e4c937fd17a8', '9-集成电路布图设计保护条例.doc', 4, '# 第二章 布图设计专有权
...
第十二条 布图设计专有权的保护期为 10 年，自布图设计登记申请之日或者在世界任何地方首次投入商业利用之日起计算，以较前日期为准。但是，无论是否登记或者投入商业利用，布图设计自创作完成之日起 15 年后，不再受本条例保护。

第十三条 布图设计专有权属于自然人的，该自然人死亡后，其专有权在本条例规定的保护期内依照继承法的规定转移。

布图设计专有权属于法人或者其他组织的，法人或者其他组织变更、终止后，其专有权在本条例规定的保护期内由承继其权利、义务的法人或者其他组织享有；没有承继其权利、义务的法人或者其他组织的，该布图设计进入公有领域。', 692);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_09c57ed2d73a', '9-集成电路布图设计保护条例.doc', 5, '# 第三章 布图设计的登记
...
第二十一条 在布图设计登记公告前，国务院知识产权行政部门的工作人员对其内容负有保密义务。', 677);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_6a6cb875004c', '9-集成电路布图设计保护条例.doc', 6, '# 第四章 布图设计专有权的行使
...
非自愿许可的理由消除并不再发生时，国务院知识产权行政部门应当根据布图设计权利人的请求，经审查后作出终止使用布图设计非自愿许可的决定。', 761);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_f5cfacd7aebc', '9-集成电路布图设计保护条例.doc', 7, '检查部门依法认定布图设计权利人有不正当竞争行为而需要给予的补救。
...
第二十九条 布图设计权利人对国务院知识产权行政部门关于使用布图设计非自愿许可的决定不服的，布图设计权利人和取得非自愿许可的自然人、法人或者其他组织对国务院知识产权行政部门关于使用布图设计非自愿许可的报酬的裁决不服的，可以自收到通知之日起3个月内向人民法院起诉。', 373);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_e1fce4223fa1', '9-集成电路布图设计保护条例.doc', 8, '# 第五章 法律责任
...
第三十三条 在获得含有受保护的布图设计的集成电路或者含有该集成电路的物品时，不知道也没有合理理由应当知道其中含有非法复制的布图设计，而将其投入商业利用的，不视为侵权。', 749);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_80d652e77834', '9-集成电路布图设计保护条例.doc', 9, '停止有关行为和财产保全的措施。
...
第三十四条 国务院知识产权行政部门的工作人员在布图设计管理工作中玩忽职守、滥用职权、徇私舞弊，构成犯罪的，依法追究刑事责任；尚不构成犯罪的，依法给予行政处分。', 253);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_e32c2c2a16fb', '9-集成电路布图设计保护条例.doc', 10, '# 第六章 附则

第三十五条 申请布图设计登记和办理其他手续，应当按照规定缴纳费用。缴费标准由国务院物价主管部门、国务院知识产权行政部门制定，并由国务院知识产权行政部门公告。

第三十六条 本条例自2001年10月1日起施行。', 114);