INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_8060baea2e7e', '专利标示标注办法.doc', 1, '# 第六十三号
...
二〇一二年三月八日', 68);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_592403cfc8f6', '专利标示标注办法.doc', 2, '# 专利标识标注办法
...
（一）采用中文标明专利权的类别，例如中国发明专利、中国实用新型专利、

中国外观设计专利；', 330);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_10b614c0594d', '专利标示标注办法.doc', 3, '# （二）国家知识产权局授予专利权的专利号。
...
第十条 本办法自2012年5月1日起施行。2003年5月30日国家知识产权局令第二十九号发布的《专利标记和专利号标注方式的规定》同时废止。', 420);