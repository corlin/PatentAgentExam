INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_ce0c9e2ee76f', '专利行政执法办法.doc', 0, '# 国家知识产权局令
...
第六条 管理专利工作的部门可以依据本地实际，委托有实际处理能力的市、县级人民政府设立的专利管理部门查处假冒专利行为、调解专利纠纷。', 797);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_af348ff9c5cb', '专利行政执法办法.doc', 1, '利行政执法遇到疑难问题的，国家知识产权局应当给予必要的指导和支持。
...
案件承办人员的回避，由管理专利工作部门的负责人决定。是否回避的决定作出前，被申请回避的人员应当暂停参与本案的工作。', 271);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_8e670d3c70b4', '专利行政执法办法.doc', 2, '# 第二章 专利侵权纠纷的处理
...
请求书应当由请求人签名或者盖章。', 739);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_17909906b9d0', '专利行政执法办法.doc', 3, '理人的姓名和代理机构的名称、地址；
...
第十二条 管理专利工作的部门应当在立案之日起 5 个工作日内将请求书及其附件的副本送达被请求人，要求其在收到之日起 15 日内提交答辩书并按照请求人的数量提供答辩书副本。被请求人逾期不提交答辩书的，不影响管理专利工作的部门进行处理。
...
第十五条 管理专利工作的部门举行口头审理的，应当将口头审理的参加人和审理要点记入笔录，经核对无误后，由案件承办人员和参加人签名或者盖章。', 734);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_f8675d4e9320', '专利行政执法办法.doc', 4, '许中途退出的，对请求人按撤回请求处理，对被请求人按缺席处理。
...
案件处理过程中的公告、鉴定、中止等时间不计入前款所述案件办理期限。', 795);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_6b53838280f5', '专利行政执法办法.doc', 5, '# 第三章 专利纠纷的调解
...
经调解达成协议的，当事人应当持调解协议书向国家知识产权局办理恢复手续；达不成协议的，当事人应当持管理专利工作的部门出具的撤销案件通知书向国家知识产权局办理恢复手续。自请求中止之日起满1年未请求延长中止的，国家知识产权局自行恢复有关程序。', 769);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_cb7a366ed8cb', '专利行政执法办法.doc', 6, '# 第四章 假冒专利行为的查处
...
第三十二条 对情节复杂或者重大违法行为给予较重的行政处罚的，应当由管理专利工作的部门负责人集体讨论决定。', 793);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_998b201c7a8f', '专利行政执法办法.doc', 7, '、理由和证据应当进行核实。当事人提出的事实属实、理由成立的，管理专利工作的部门应当予以采纳。
...
第三十四条 管理专利工作的部门查处假冒专利案件，应当自立案之日起 1 个月内结案。案件特别复杂需要延长期限的，应当由管理专利工作的部门负责人批准。经批准延长的期限，最多不超过 15 日。

案件处理过程中听证、公告等时间不计入前款所述案件办理期限。', 399);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_401e27eb0c7c', '专利行政执法办法.doc', 8, '# 第五章 调查取证
...
经登记保存的证据，被调查的单位或者个人不得销毁或者转移。', 756);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_fa7fe679eb3a', '专利行政执法办法.doc', 9, '人一份。
...
管理专利工作的部门处理涉及进出口货物的专利案件的，可以请求海关提供协助。', 403);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_a6375787cf12', '专利行政执法办法.doc', 10, '# 第六章 法律责任
...
（五）侵权人进口专利侵权产品或者依照专利方法直接获得的侵权产品的，责令侵权人立即停止进口行为；侵权产品已经入境的，不得销售、使用该侵权产品或者以任何其他形式将其投放市场；侵权产品难以保存的，责令侵权人销毁该产品；侵权产品尚未入境的，可以将处理决定通知有关海关；', 611);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_0522eec61e0f', '专利行政执法办法.doc', 11, '# （六）停止侵权行为的其他必要措施。
...
（二）订立假冒专利的合同的，以收取的费用作为其违法所得。', 760);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_0926b1bc8ff6', '专利行政执法办法.doc', 12, '假冒专利行为成立的，可以按照下列方式确定行为人的违法所得：
...
第四十八条 拒绝、阻碍管理专利工作的部门依法执行公务的，由公安机关根据《中华人民共和国治安管理处罚法》的规定给予处罚；情节严重构成犯罪的，由司法机关依法追究刑事责任。', 333);
INSERT OR REPLACE INTO reference_materials (id, source_file, chunk_index, content, tokens) VALUES ('ref_7ec8f850e3ac', '专利行政执法办法.doc', 13, '# 第七章 附 则

第四十九条 管理专利工作的部门可以通过寄交、直接送交、留置送达、公告送达或者其他方式送达有关法律文书和材料。

第五十条 本办法由国家知识产权局负责解释。

第五十一条 本办法自 2011 年 2 月 1 日起施行。2001 年 12 月 17 日国家知识产权局令第十九号发布的《专利行政执法办法》同时废止。', 165);